...
internal static class L
{
    ...
    internal static class Muster
    {
        ...
        public static readonly LocString PartySlots = new("muster.partySlots", "{0}/{1}");
        public static readonly LocString PartyFinderBadge = new("muster.partyFinderBadge", "Party Finder");
        public static readonly LocString MusterBadge = new("muster.musterBadge", "Muster");
        public static readonly LocString PartyFinderDutyRoulette = new("muster.partyFinderDutyRoulette", "Roulette");
        public static readonly LocString PartyFinderDutyDungeons = new("muster.partyFinderDutyDungeons", "Dungeon");
        public static readonly LocString PartyFinderDutyTrials = new("muster.partyFinderDutyTrials", "Trial");
        public static readonly LocString PartyFinderDutyRaids = new("muster.partyFinderDutyRaids", "Raid");
        public static readonly LocString PartyFinderDutyHighEnd = new("muster.partyFinderDutyHighEnd", "Savage");
        public static readonly LocString PartyFinderSheetTitle = new("muster.partyFinderSheetTitle", "Party Finder listing");
        public static readonly LocString PartyFinderSheetJoinHint = new("muster.partyFinderSheetJoinHint", "Use the in-game Party Finder to join this party.");
        public static readonly LocString PartyFinderWorld = new("muster.partyFinderWorld", "World");
        public static readonly LocString PartyFinderSlots = new("muster.partyFinderSlots", "Slots");
        public static readonly LocString PartyFinderParties = new("muster.partyFinderParties", "Parties");
        public static readonly LocString PartyFinderItemLevel = new("muster.partyFinderItemLevel", "Minimum item level");
        public static readonly LocString PartyFinderBeginners = new("muster.partyFinderBeginners", "Beginners welcome");
